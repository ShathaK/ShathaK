 ...
 * This interface (Welcome_Page) allow the user to login or make new account.
 * 
 */
public class Welcome_Page extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        setSize(new java.awt.Dimension(600, 760));

        jPanel1.setBackground(new java.awt.Color(255, 228, 216));
        jPanel1.setPreferredSize(new java.awt.Dimension(600, 760));

        jLabel1.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/cat care logo.jpg"))); // NOI18N
        ...
        jLabel3.setText("to Cat Care System");
    ...
    // This button used to transform the user to (Login_Page)
    private void LoginActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_LoginActionPerformed
        this.dispose();
        new Login_Page().setVisible(true);
    }//GEN-LAST:event_LoginActionPerformed

    // This button used to transform the user to (Register_Page)
